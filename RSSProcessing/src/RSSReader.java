...
public final class RSSReader {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        out.println("<h1><a href=" + link + ">" + title + "</h1>");
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        if (descriptionIndex >= 0) {
            //if it does exist check if the number of children is not -1
            if (item.child(descriptionIndex).numberOfChildren() != -1) {
        ...
        if (linkIndex >= 0) {
            ...
            if (item.child(linkIndex).numberOfChildren() != -1) {
        ...
        if (dateIndex >= 0) {
            //if it does exist check if the number of children is not -1
            if (item.child(dateIndex).numberOfChildren() != -1) {
                //if date has children then assign date to the label of its child
        ...
        out.println("<td><a href=" + source + ">" + sourceLabel + "</td>");
    ...
    public static void main(String[] args) {
        ...
        //ask user for a RSS URL
        out.println("Input a RSS URL");
        String url = in.nextLine();
        //ask user for an html file name
        out.println("Input a file name: ");
        ...
        for (int i = 0; i < xml.child(0).numberOfChildren(); i++) {
            //if there is a child label that equals item then call the processItem method

...
public final class Newton4 {
    ...
    public static void main(String[] args) {
         ...
         *
         * nested if statement that determines the boolean value of ask, if num
         * is less than 0, then ask will be set to False. Else the program will
         * ask the user to input a number to be sqaure rooted, as well as asking
         * the user to input an error value. This process will continue until
         * the user inputs anything other than 'y'.
         */
